...
jude_fit <- pj_samps_jude %>% dplyr::select(pptSeasonality,
                                     meanTempDryQuart,
                                     meanTempWetQuart,
                                     pptDryMonth,
                                     tempAnnualRange,
...
# Preprocess data
pj_rec_jude <-  recipe(~pptSeasonality+
                       meanTempDryQuart+
                       meanTempWetQuart+
                       pptDryMonth+
                       tempAnnualRange+
...
ggsave(filename = "Graphs/jupi_biplot_120123.tiff",
       plot = jupi_biplot,
       dpi = 800, 
       width = 8,
       height = 6,
